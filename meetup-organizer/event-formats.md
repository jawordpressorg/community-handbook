...
*   **コワーキング/ワークアロング** – 時に個人プロジェクトのやる気を維持するための最良の方法は、行き詰まった時に人と一緒に話しをすることです。ワークアロングを開催するには、電源コンセント、 Wi-Fi テーブルと机、参加者人数分のスペースが必要になるでしょう。そして、仲間とともに行動し、互いに意見を出し合いましょう。
